...
export function Slide(props: SlideProps) {
    let style = { "--offset": 100 * props.offset + "%", "--slideDuration": props.slideDuration } as React.CSSProperties
    return (
        <div className="slide" style={{ ...style, zIndex: props.hidden ? -100 : 0, transition: props.hidden ? "all 0ms none" : `transform ${props.slideDuration} ease-in-out` }}>
